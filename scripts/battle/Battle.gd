...
func _create_single_party_status_panel(combatant: Dictionary) -> PanelContainer:
	...
	hp_value.add_theme_constant_override("outline_size", 4)
	...
	mp_label.add_theme_constant_override("outline_size", 4)
	...
	mp_value.add_theme_constant_override("outline_size", 4)
